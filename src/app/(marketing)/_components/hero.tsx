  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-primary via-violet-500 to-primary bg-[length:200%_auto] animate-gradient opacity-0 group-hover:opacity-100 transition-opacity" />
            </Button>
            <Button
              size="lg"
              variant="outline"
            ...
            >
              <Link href="#demo" className="flex items-center">
                <div className="mr-3 h-10 w-10 rounded-full bg-gradient-to-br from-primary/20 to-violet-500/20 flex items-center justify-center group-hover:scale-110 transition-transform">
                ...
                {[
                  ...
                  >
                    <Avatar className="h-11 w-11 border-[3px] border-background ring-2 ring-primary/10 hover:ring-primary/30 transition-all hover:scale-110 hover:z-10">
                      <AvatarFallback
                        className={`text-[11px] font-bold bg-gradient-to-br ${user.gradient} text-white`}
                      >
                        {user.initials}
                      </AvatarFallback>
                    </Avatar>
        ...
        >
          {/* Glow effects */}
          <div className="absolute -inset-4 bg-gradient-to-r from-primary/30 via-violet-500/20 to-primary/30 blur-3xl opacity-30 animate-glow" />

          {/* Main container */}
          <div className="relative rounded-2xl lg:rounded-3xl p-px bg-gradient-to-b from-border/80 via-border/40 to-transparent overflow-hidden">
            <div className="rounded-2xl lg:rounded-3xl bg-background/80 backdrop-blur-xl overflow-hidden shadow-2xl">
              ...
              >
                <div className="rounded-2xl bg-gradient-to-br from-primary via-primary to-violet-600 p-5 shadow-2xl shadow-primary/30 text-primary-foreground">
                  <div className="flex items-center gap-4">
